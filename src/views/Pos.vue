  ...
  <div class="page">
    ...
    <div class="page-wrapper">
      <div class="container-xl mt-4">
        <!-- Top Bar: Tanggal, Member, Scan & Total -->
              ...
              <tbody>
                <tr v-for="(item, idx) in cart" :key="idx">
                  ...
                  <td>
                    ...
                    >
                      <option v-for="u in getUnits(item.product_id)" :key="u.id" :value="u.id">
                        {{ u.unit_name }}
                      </option>
                    </select>
                  </td>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" @click="confirmCheckout()" :disabled="!canPay">
                  Cetak Struk
                </button>
              </div>
            </div>
...
export default {
  ...
  setup() {
    ...
    const isMember = computed(() => selectedMemberId.value !== null)
    ...
    onMounted(async () => {
      // load members
      members.value = await window.api.fetchMembers()
